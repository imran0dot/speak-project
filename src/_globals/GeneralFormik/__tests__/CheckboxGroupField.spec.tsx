  ...
  "fields": [
        {
          "type": "checkbox",
          "name": "checkbox_field",
          "label": "Example of checkbox field",
          "options": [
            {
              "label": "Option 1",
              "value": "0"
...
describe('Checkbox Input tests', () => {
  ...
  it('checkbox_fieldEl should render', () => {
    const { container  } = render(<GeneralFormik schema={schema2} submitHandler={()=>{jest.fn()}} />)
    const checkbox_fieldEl = container.querySelector(`input[name="checkbox_field"]`);
    expect(checkbox_fieldEl).toBeDefined();
  })
